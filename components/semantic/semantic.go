...
// Hit is a recalled Item with a similarity score (higher = more similar).
// Score is normalized similarity (1 - cosine distance), matching the
// higher-is-better semantics of gantry.Document.Score.
//
