...
func TestRunParallelExecutesAllJobs(t *testing.T) {
	...
	if err := harness.RunParallel(context.Background(), 8, jobs); err != nil {
...
func TestRunParallelLimitsConcurrency(t *testing.T) {
	...
	if err := harness.RunParallel(context.Background(), limit, jobs); err != nil {
		t.Fatalf("RunParallel: %v", err)
	}
	if peak > int64(limit) {
...
func TestRunParallelReturnsFirstError(t *testing.T) {
	...
	err := harness.RunParallel(context.Background(), 2, jobs)
...
func TestRunParallelRespectsContextCancellation(t *testing.T) {
	...
	err := harness.RunParallel(ctx, 1, jobs)
