...
// sessionID is set only for new-session (spawn_session) requests. dependsOn
// carries the same-session task ids a create_task spawn is gated on (plan 13),
// validated at drain time by enqueueSpawns.
